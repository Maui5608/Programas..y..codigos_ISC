...
def main():
    ...
    while True:
        ...
        try:
            cantidad_n = leer_entero("Ingrese la cantidad de números a generar: ")
            semilla = leer_entero("Ingrese la semilla: ")
            generador = GeneradorPseudoAleatorio(semilla)

            if choice == '1':
                print(generador.cuadrados_medios(cantidad_n, semilla))
            elif choice == '2':
                semilla_2 = leer_entero("Ingrese la segunda semilla: ")
                print(generador.productos_medios(cantidad_n, semilla, semilla_2))
            elif choice == '3':
                constante = leer_entero("Ingrese la constante: ")
                print(generador.multiplicador_constante(cantidad_n, semilla, constante))
            elif choice == '4':
                a = leer_entero("Ingrese la constante multiplicativa (a): ")
                c = leer_entero("Ingrese la constante aditiva (c): ")
                m = leer_entero("Ingrese el módulo (m): ")
                ...
                n = leer_entero("Ingrese la cantidad de valores iniciales (n): ")
                semillas = [leer_entero(f"Ingrese el valor inicial {i+1}: ") for i in range(n)]
                m = leer_entero("Ingrese el módulo (m): ")
